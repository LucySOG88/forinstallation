...
module.exports = function Cloudflare() {
 ...
 if (process.argv.length < 9){console.log(`invalid usage!\n./rapid-reset [mode] [time] [threads] [proxyfile] [rate] [target] [query]\nDeveloper @Manusiapendosa1 - LayangTerbang is Here`); process.exit();}
 const headers = {};
